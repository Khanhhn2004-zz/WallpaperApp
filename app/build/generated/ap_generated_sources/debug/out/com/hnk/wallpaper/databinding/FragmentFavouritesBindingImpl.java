...
public class FragmentFavouritesBindingImpl extends FragmentFavouritesBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.im_filter, 1);
        sViewsWithIds.put(R.id.tv_name_collection, 2);
        sViewsWithIds.put(R.id.tv_size_result, 3);
        sViewsWithIds.put(R.id.rcl_favorite, 4);
        sViewsWithIds.put(R.id.im_no_favorite, 5);
        sViewsWithIds.put(R.id.tv_no_favorite, 6);
    }
    // views
    @NonNull
